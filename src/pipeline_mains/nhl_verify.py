                ...
                for topic_partition, records in messages.items():
                    for record in records:
                        ...
                        if analytics.get("game_state") == "in":
                            ...
                            print(
                                f"Assists: {safe_format(analytics.get('home_assists'))}"
                            )
                            print(
                                f"Points: {safe_format(analytics.get('home_points'))}"
                            )
                            # print(
                            ...
                            print(
                                f"Assists: {safe_format(analytics.get('away_assists'))}"
                            )
                            print(
                                f"Points: {safe_format(analytics.get('away_points'))}"
                            )
                            # print(
