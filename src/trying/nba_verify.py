                ...
                for topic_partition, records in messages.items():
                    for record in records:
                        ...
                        if True or game_data.get("status_state") == "in":
                            ...
                            print(
                                f"{home_team} (Home): {game_data.get('home_team_score')}"
                            )
                            print(
                                f"{away_team} (Away): {game_data.get('away_team_score')}"
                            )
                            ...
                            print(
                                f"Home rebounds: {game_data.get('home_rebounds')}"
                            )
                            print(
                                f"Away rebounds: {game_data.get('away_rebounds')}"
                            )
                            ...
                            print(
                                f"Home turnovers: {game_data.get('home_turnovers')}"
                            )
                            print(
                                f"Away turnovers: {game_data.get('away_turnovers')}"
                            )
