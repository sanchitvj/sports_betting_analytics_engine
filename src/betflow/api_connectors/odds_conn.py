    ...
    def fetch_and_publish_odds(
        ...
        try:
            ...
            for game in raw_data:
                transformed_data = self.transform_odds_data(game)
                self.publish_to_kafka(f"odds.{sport}.odds", transformed_data)
